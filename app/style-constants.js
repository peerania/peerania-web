...
const gold = _get(colors, 'gold', PEER_PREMIUM_COLOR);
const lightgold = _get(colors, 'lightgold', PEER_PREMIUM_TRANSPARENT_COLOR);
...
const goldRGB = _get(colors, 'goldRGB', `255, 133, 0`);
...
export const TEXT_PREMIUM = gold;
...
export const BORDER_PREMIUM = gold;
export const BORDER_PREMIUM_RGB = goldRGB;
...
export const BG_PREMIUM_LIGHT = lightgold;
